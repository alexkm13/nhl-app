...
async def get_player_info(player_id: int, player_names: dict, player_headshots: dict, 
                          redis=None) -> tuple:
...
def calculate_strength_from_situation(situation: str, team: str, home_skaters: int, 
                                      away_skaters: int) -> str:
...
def calculate_goal_distance(x_coord: float, y_coord: float, play: dict, team: str, 
                            period1_baseline: dict = None) -> int:
...
def format_goal_description(shot_type: str, distance: int, game_situation: str, 
                             strength: str, assists: list = None) -> str:
