...
def main():
    ...
    parser.add_argument(
        "--model-id",
        default="lightgbm_20251104_115151_e21578a7",
        help="Model ID to use",
    )
    parser.add_argument("--days", type=int, default=7, help="Number of days to process")
    parser.add_argument(
        "--limit", type=int, default=None, help="Limit number of predictions"
    )
    ...
    asyncio.run(
        generate_predictions_from_features(
            args.db_url, args.redis_url, args.model_id, args.days, args.limit
        )
    )
