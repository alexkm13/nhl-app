...
def train_improved_model(
    config_path: str, improvements: list = None, save_model: bool = True
):
    """
    ...
    if improvements and any(
        "calibration" in imp.lower() or "temperature" in imp.lower()
    ...
    if improvements and any(
        "hyperparameter" in imp.lower() or "tuning" in imp.lower()
        for imp in improvements
    ):
...
def main():
    ...
    parser.add_argument(
        "--improvements", nargs="+", help="List of improvements to apply"
    )
    parser.add_argument(
