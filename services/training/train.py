...
async def main():
    ...
    parser.add_argument("--model-type", type=str, choices=["xgboost", "lightgbm", "catboost"],
    ...
    parser.add_argument("--save-model", action="store_true", help="Save model to registry")
    ...
    if args.learning_rate:
        ...
        if 'hyperparameters' not in override_config['training']:
            override_config['training']['hyperparameters'] = {}
        override_config['training']['hyperparameters']['learning_rate'] = args.learning_rate
    if args.max_depth:
        if 'training' not in override_config:
            override_config['training'] = {}
        if 'hyperparameters' not in override_config['training']:
    ...
    model = WinProbabilityModel(model_type=model_config['model_type'], **model_config.get('hyperparameters', {}))
